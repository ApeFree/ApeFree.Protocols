...
{
    public class JbinConcurrentQueueShortsConverter : JbinConverter<ConcurrentQueue<short[]>>
    {
        protected override ConcurrentQueue<short[]> ConvertBytesToValue(byte[] bytes, Type objectType)
        {
